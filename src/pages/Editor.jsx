...
db.version(1).stores({
  diaries: "++id, month, year", // Indexed fields. Data like travelGroups is stored but doesn't need indexing here.
});
...
export default function App() {
  ...
  const handleEditDiary = (diary) => {
    ...
    setTravelGroups(diary.travelGroups || []);
  ...
  const handleReset = () => {
    if (window.confirm("Are you sure you want to clear all data?")) {
      setMeta({ month: "", year: "" }); // current as default
      setTravelGroups([]);
      setLeaveEntries([]);
    }
  };
    ...
    return (
      <div className="max-w-md mx-auto p-4 min-h-screen">
        ...
        <div>
          ...
          {console.log("savedDiaries:", savedDiaries)}
                      ...
                      <div className="grid grid-cols-2 gap-2 ml-2">
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              updatePendingRow(group.id, "from", e.target.value)
                            }
                          />
                        </div>
                        <div>
